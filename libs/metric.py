...
def sparse_ml(n_clusters, n_code, nebula3d, feat, label, info_type='scalar'):
    ...
    with tf.variable_scope('Metric'):
        ...
        elif info_type is 'unsupervised':
    ...
    return loss_0d, loss_1d, loss_2d, loss_3d, nebula1d, nebula2d, nebula3d, index, dist_0d
