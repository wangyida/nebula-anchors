...
class ScanFile(object):
    def __init__(self, directory, prefix=None, postfix='.png'):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        dest="dir_src",
        default=
        "/home/user/Documents/yida/database/annotated_data/annotated_img",
    ...
    parser.add_argument(
        ...
        dest="dir_tar",
        default=
        "/home/user/Documents/yida/database/annotated_data/annotated_obj",
